...
def main():
    try:
        ...
        if selected_modules:
            ...
            st.write(access_method_keys)
            st.write(access_method_factors.get(access_method_keys, 0))  # debug message
            ...
            multi_year_discount = contract_discounts.get(contract_length) /100 # Calculate multi-year discount based on contract length
